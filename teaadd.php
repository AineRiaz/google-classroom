...
<nav style="background-color:sky;" class="navbar bg-body-tertiary">
  <div class="container-fluid">
    <a href="people.php"style=" text-decoration:none;color:black;font-size:35px;" class="navbar-brand mb-0 h1">x </a>
  </div>
</nav>
<div class="container">
...
if(isset($_POST['submit']))
{
  ...
  $title=$_POST['teacher'];
 $create_query = "INSERT INTO teachers (`id`,`class name`, `teacher`) VALUES (Null,'$class','$title')";
